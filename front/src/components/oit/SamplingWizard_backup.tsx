...
export interface SamplingData {
  ...
  // Nuevos campos para evidencias/im├ígenes
...
export default function SamplingWizard({
  ...
  const allowedStep = useMemo(() => {
    // Paso m├íximo alcanzable seg├║n validaciones previas
    let max = 0;
    for (let i = 0; i <= 4; i++) {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
        {["Definici├│n", "Poblaci├│n", "Muestra", "Plan", "Resultados"].map((label, idx) => (
          <div
            key={idx}
      ...
      {step === 1 && (
        <div className="form-grid" style={{ gap: 12 }}>
          <div className="input-group">
            <label className="label">
              Poblaci├│n/Universo <span style={{ color: "#d33" }}>*</span>
            </label>
            <input
              className="input"
              type="number"
              min={1}
              placeholder="N├║mero total de elementos"
              value={data.universo ?? ""}
              onChange={(e) =>
          ...
          <div className="input-group">
            <label className="label">
              Criterios de inclusi├│n <span style={{ color: "#d33" }}>*</span>
            </label>
            <textarea
              className="input"
              rows={3}
              placeholder="Qu├® elementos entran en la muestra"
      ...
      {step === 2 && (
        <div className="form-grid" style={{ gap: 12 }}>
          <div className="input-group">
            <label className="label">
              M├®todo de muestreo <span style={{ color: "#d33" }}>*</span>
            </label>
            <select
              className="input"
              value={data.metodo || ""}
            ...
            >
              ...
              <option value="sistematico">Sistem├ítico</option>
          ...
          <div className="input-group">
            <label className="label">
              Tama├▒o de la muestra <span style={{ color: "#d33" }}>*</span>
            </label>
            <input
              className="input"
              type="number"
      ...
      {step === 3 && (
        <div className="form-grid" style={{ gap: 12 }}>
          <div className="input-group">
            ...
            <input
              className="input"
              placeholder="Ej. Puntos, veh├¡culos, equiposÔÇª"
              value={data.unidades || ""}
          ...
          <div className="input-group">
            <label className="label">
              Aleatoriedad/selecci├│n <span style={{ color: "#d33" }}>*</span>
            </label>
            <input
              className="input"
              placeholder="C├│mo se seleccionan las unidades"
          ...
          <div className="input-group" style={{ gridColumn: "1 / -1" }}>
            <label className="label">Evidencia del plan (im├ígenes opcionales, m├íx. 6 ├ù 1.5MB)</label>
            <input
              className="input"
              type="file"
              accept="image/*"
      ...
      {step === 4 && (
        <div className="form-grid" style={{ gap: 12 }}>
          ...
          <div className="input-group" style={{ gridColumn: "1 / -1" }}>
            <label className="label">Fotos/Evidencias (opcionales, m├íx. 6 ├ù 1.5MB)</label>
            <input
              className="input"
              type="file"
              accept="image/*"
